const routes = [
  ...
  },
  {
    path: '/escolta',
    component: () => import('layouts/AurigaLayout.vue'),
    children: [{ path: '', component: () => import('pages/AurigaEscolta.vue') }]
  },
  {
    path: '/fenix',
    component: () => import('layouts/FenixLayout.vue'),
    children: [{ path: '', component: () => import('pages/Fenix.vue') }]
  },
  {
    path: '/fenixbasic',
    component: () => import('layouts/EmptyLayout.vue'),
    children: [{ path: '', component: () => import('pages/FenixBasic.vue') }]
  },
  {
    path: '/aurigabasic',
    component: () => import('layouts/EmptyLayout.vue'),
    children: [{ path: '', component: () => import('pages/AurigaBasic.vue') }]
  },
  {
    path: '/map',
    component: () => import('layouts/AurigaLayout.vue'),
  ...
  },
  {
    ...
    children: [{ path: '/', component: () => import('pages/Pilot.vue') }]
  },
  {
    path: '/alarmas',
    component: () => import('layouts/AurigaLayout.vue'),
    children: [{ path: '', component: () => import('pages/Alarmas.vue') }]
  }
]
